...
## Note: 
1. Do not hardcode 
2. Do not write fallback mechanism and backward compatability functionality.
3. Do not write too many try and except blocks
4. All the libraries import must be at the top.
